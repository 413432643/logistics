<template>
  <el-row :gutter="10" style="margin: 0; padding: 0; margin-top: 1vh">
    <el-col :span="6">
      <chartpanel title="实时订单" style="height: 30vh"> </chartpanel>
      <chartpanel title="来源分布" style="height: 30vh;margin-top: 1vh;"> </chartpanel>
    </el-col>
    <el-col :span="18">
  ...
  <el-row :gutter="10" style="margin: 0; padding: 0; margin-top: 1vh">
    <el-col :span="6">
      <chartpanel title="订单走势" style="height: 30vh"> </chartpanel>
    </el-col>
    <el-col :span="6">
      <chartpanel title="类型分布" style="height: 30vh"> </chartpanel>
    </el-col>
    <el-col :span="6">
      <chartpanel title="发布地分布" style="height: 30vh"> </chartpanel>
    </el-col>
    <el-col :span="6">
      <chartpanel title="目的地分布" style="height: 30vh"> </chartpanel>
    </el-col>
  </el-row>
</template>
